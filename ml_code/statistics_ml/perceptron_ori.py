...
class Perceptron:
    def __init__(self,x,y,a=1):
        self.x=x
        self.y=y
        self.w=np.zeros((x.shape[1],1))                           # 初始化权重，w1,w2均为0; 4 X 1
        self.b=0                                                  # initial the param b | 4 X 1
        self.a=1                                                  # the rate of the learning
    ...
    def update(self,label_i,data_i):
        ...
        tmp=tmp.reshape(self.w.shape)                             # matrix transposition
        # 更新w和b
        self.w=tmp+self.w
